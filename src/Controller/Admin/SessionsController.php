...
class SessionsController extends AppController
{
    ...
    public function add()
    {
        ...
        $annees = $this->Sessions->Annees->find('list', ['limit' => 200]);
        $mois = $this->Sessions->Mois->find('list', ['limit' => 200]);
        $this->set(compact('session', 'users', 'annees', 'mois'));
    }
