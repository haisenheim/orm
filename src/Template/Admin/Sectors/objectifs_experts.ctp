<h3 class="page-header text-center">PLANNING DE RECRUTEMENT DES EXPERTS</h3>
<div class="" style="">
    <div class="" style=" ">
        <a href="<?= $this->Url->build(['controller'=>'Sectors','action'=>'projecter']) ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> EDITER</a>
