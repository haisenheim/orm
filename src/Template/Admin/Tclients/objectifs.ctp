<h3 class="page-header text-center">PLANNING DE CREATION DES COMPTES CLIENTS</h3>
<div class="" style="">
    <div class="" style=" ">
        <a href="<?= $this->Url->build(['controller'=>'Tclients','action'=>'planifier']) ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> EDITER</a>
