...
<div class="dossiers view large-9 medium-8 columns content">
    <h6 class="page-header">
        ...
        <?php else: ?>
            <a class="btn btn-success btn-sm" href="<?= $this->Url->build(['controller'=>'Dossiers','action'=>'setup', $dossier->id]) ?>"><i class="fa fa-calendar-alt"></i> PARAMETRER LE SUIVI</a>
        <?php endif; ?>
        <a class="btn btn-success btn-sm pull-right" href="<?= $this->Url->build(['controller'=>'Dossiers','action'=>'edit', $dossier->id]) ?>"><i class="fa fa-edit"></i> Modifier</a>
    </h6>
