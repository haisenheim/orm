...
<div class="content">
    ...
    <form action="<?= $this->Url->build(['action'=>'edit', $pligne->id]) ?>" method="post">
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <div class="col-sm-12 col-md-6 col-lg-6">
                <label for="">PROCES VERBAL DE REALISATION : </label>
                <textarea  name="pv" id="pv" style="min-height: 200px; min-width: 98%; border-radius: 5px;  border: solid 1px lightgrey; padding: 10px">
        ...
        <div class="row">
            <div style="max-width: 300px; margin: 20px auto" class="">
                <button class="btn btn-sm btn-success btn-block"><i class="fa fa-save"></i> Enregister le PV</button>
            </div>
        </div>
    </form>
