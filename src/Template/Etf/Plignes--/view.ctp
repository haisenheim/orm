...
<div class="content">
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-lg-6 col-md-6">
            <p>PERSONNE PILOTE : <span class="value"><?=  $pligne->pilote?$pligne->pilote->name:'-' ?></span></p>
        </div>
    ...
    <div class="row">
       <div style="max-width: 300px; margin: 20px auto" class="">
           <a href="<?= $this->Url->build(['action'=>'edit', $pligne->id]) ?>" class="btn btn-sm btn-success btn-block"><i class="fa fa-pencil-alt"></i> Editer le PV</a>
       </div>
    </div>
