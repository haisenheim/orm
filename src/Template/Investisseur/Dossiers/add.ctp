    ...
    <div>
        <div class="row section" id="section-1" style="border: solid 1px #cccccc; border-radius: 7px; padding: 10px; margin: 5px">
            <div class="col-md-6 col-lg-6 col-sm-12">
                ...
                <div style="padding: 10px; border: solid 1px #cccccc; border-radius: 4px">
                    <h6>ESPACE CLIENT</h6>
                    <div class="row">
                        <div class="col-lg-2 col-md-2 col-sm-12">
                            <span class="">
                                <a style="margin-top: 30px" title="Creer un nouveau client" class="btn btn-info" href="<?= $this->Url->build(['controller'=>'Clients','action'=>'create']) ?>"> <i class="glyphicon glyphicon-plus"></i></a>
                            </span>
                        </div>

                            <div class="col-lg-8 col-md-8 col-sm-12">
                                <label style="margin-top:0 " for="code-client">CODE OBAC</label>
                                <input type="text" class="form-control" value="<?= !empty($client)?$client->name:'' ?>" placeholder="saisir le code" id="code-client"/>
                            </div>
                            <div class="col-lg-1 col-md-1 col-sm-12">

                                <button id="search-client" style="margin-top: 30px" title="Consulter" class="btn btn-danger" type="submit">
                                    <i class="glyphicon glyphicon-search"></i>
                                </button>

                            </div>
                    </div>
                    <div style="padding: 10px" class="" id="client-data">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="" style="border: solid 1px #cccccc; border-radius: 4px; padding: 10px; margin: 40px 0 0 0">
