...
<div class="" style="margin-top: 3%">
    <div class="container" >
        <div class="">
            ...
            <div style="max-width: 35%; margin-left: auto; margin-right: auto; border: solid lightblue 1px; border-radius: 5px; box-shadow: 0 8px 15px darkslategrey; background-color: #FFFFFF; padding: 30px; padding-top: 25px;" >
