...
<div class="contenu">
        ...
        <div class="container" style="color: #4b6584">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="<?= $this->Url->build(['controller'=>'Dossiers', 'action'=>'add' ]) ?>"><i class="fa fa-folder-open"></i>&nbsp; NOUVELLE ANALYSE DE DOSSIER</a>
                    </li>
                    <li>
                        <a href="<?= $this->Url->build(['controller'=>'Dossiers', 'action'=>'index' ]) ?>"><i class="fa fa-folder"></i>&nbsp; SUIVI DES DOSSIERS</a>
                    </li>
    ...
    <div style="">
        <div class="container" style="border-left: solid 1px #777; border-right: solid 1px #777; padding: 0 15px" >
            <div class="page-header" style="background-color: #4caf50; margin: 0 -15px; padding: 5px 0">
                <h5><?= $this->Html->image($company->imageUri?$company->imageUri:'logo-indefini.png',['fullBase'=>true,'style'=>'max-width:50px; min-height:50px; margin:-35px 3px']) ?> <span style="margin-left:30px "><span class="" style="text-shadow: 1px 1px 2px black; color: white; font-weight: 800"><?= $company->name ?></span> <span style="font-weight: 600; color: white; text-shadow: 1px 1px 1px; font-size: smaller">&nbsp; &nbsp;<?= $company->address ?> &nbsp;&nbsp;<?= $company->phone ?></span></span> <span class="page-title pull-right" style="margin-right: 20px; font-size: smaller; color: white; font-weight: 700"><?= !empty($title)?$title:'' ?></span> </h5>
            </div>
            <div class="" id="front-wrapper" style="margin-bottom: 0; min-height: 40vh">
                <?= $this->Flash->render() ?>
                <?= $this->fetch('content') ?>
            </div>
        </div>
