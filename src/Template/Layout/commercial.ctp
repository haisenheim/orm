    ...
    <div class="container" style="color: #4b6584">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="<?= $this->Url->build(['controller'=>'Dossiers', 'action'=>'index' ]) ?>"><i class="glyphicon glyphicon-open-file"></i>DOSSIERS</a>
                </li>
                <li>
                    <a href="<?= $this->Url->build(['controller'=>'Clients', 'action'=>'index' ]) ?>"><i class="glyphicon glyphicon-user"></i>PORTEURS DE PROJET</a>
                </li>
                <li>
                    <a href="#"><i class="glyphicon glyphicon-phone-alt"></i>CONTACTER OBAC</a>
                </li>
                <li>
                    <a href="#"><i class="glyphicon glyphicon-exclamation-sign"></i>AIDE</a>
                </li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
                <li><a href="<?= $this->Url->build(['controller'=>'Users', 'action'=>'login']) ?>"><i class="glyphicon glyphicon-user"></i>&nbsp; <?= $usr?$usr['first_name']." ".$usr['last_name']:'MY SPACE' ?></a></li>
                <li><a href="#"></a></li>
