    ...
    <div class="container-fluid" style="color: #4b6584">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="<?= $this->Url->build(['controller'=>'Plignes', 'action'=>'index' ]) ?>"><i class="fa fa-list" ></i>&nbsp; SUIVI DES RISQUES</a>
                </li>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    <span style="color: white; box-shadow: none;  " class=" btn dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                        ...
                        &nbsp;<?= $usr?$usr['first_name']." ".$usr['last_name']:'MY SPACE' ?>

                    </span>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                        <li>
                            <a href="<?= $this->Url->build(['controller'=>'Users', 'action'=>'edit' ]) ?>"><i class="fa fa-user"></i>&nbsp; EDITER MON PROFIL</a>
                        </li>
...
<h5 style="background-color: #4caf50; color: #FFFFFF; margin-top: -5px;margin-bottom: 0; padding-top: 15px" class="page-header"><span style="margin-left:30px ">ESPACE DE L'EXPERT METIER - <span class="" style="text-shadow: 1px 1px 2px black">OBAC</span></span> <span class="page-title pull-right" style="margin-right: 30px"><?= !empty($title)?$title:'' ?></span> </h5>
<div class="container">
    <?= $this->Flash->render() ?>
</div>
