<h3 class="page-header"> <i class="glyphicon glyphicon-tasks"></i> PLAN D'ACTION : <span class="value"><?= $plan->name ?></span>  <span class="pull-right"><i class="glyphicon glyphicon-folder-open"></i> &nbsp; DOSSIER: <span class="value"><?= $this->Html->link($plan->dossier->name,['controller'=>'Dossiers','action'=>'view',$plan->dossier->id]) ?></span> </span></h3>
            ...
            <div>
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <i class="glyphicon glyphicon-bitcoin"></i> &nbsp; PRODUIT/SERVICE: &nbsp;<span class="value"><?= $plan->dossier->produit?$plan->dossier->produit->name:'-' ?></span>
                        <br/>
